...
public class BallLogic extends PhysicsObjectLogic {
    ...
    public BallLogic(double v, double d, double m, double x, double y, double r, double rb, double g, int fps) { super(v,d,m,x,y,g, fps); radius = r; rebound = rb; updateCartesianVelocities(); }
