...
public class BallLogic extends PhysicsObjectLogic {
    ...
    public BallLogic(double v, double d, double m, double x, double y, double r, double rb, double g) { super(v,d,m,x,y,g); radius = r; rebound = rb; updateCartesianVelocities(); }
